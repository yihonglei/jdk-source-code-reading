...
package com.lanhuigu.jvm.compiler.apt.main;
...
public class AptJavaCompiler extends com.sun.tools.javac.main.JavaCompiler {
    ...
    java.util.Set<File> aggregateGenFiles = java.util.Collections.emptySet();

    public java.util.Set<File> getAggregateGenFiles() {
    ...
    public List<ClassSymbol> compile(List<String> filenames,
                                     ...
                                     java.util.Set<File> aggregateGenFiles)
        throws Throwable {
