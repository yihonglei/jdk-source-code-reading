...
package com.lanhuigu.jvm.compiler.apt.comp;
...
public class Apt extends ListBuffer<Env<AttrContext>> {
    ...
    public void main(com.sun.tools.javac.util.List<JCTree.JCCompilationUnit> treeList,
        ...
        if (options.get("-print") != null) {
            ...
            Iterator<AnnotationProcessorFactory> providers = null;
            {
                /*
                ...
                List<AnnotationProcessorFactory> list =
            ...
            Map<AnnotationProcessorFactory, Set<AnnotationTypeDeclaration>> factoryToAnnotation =
            ...
            {
                Set<Class<? extends AnnotationProcessorFactory> > neglectedFactories =
