 ...
 * questions.
 */
package com.lanhuigu.jvm.compiler.javac.util;
...
public class RichDiagnosticFormatter extends
    ...
    protected class RichPrinter extends Printer {
        ...
        public String visitClassType(ClassType t, Locale locale) {
            if (t.isCompound() &&
                    getConfiguration().isEnabled(RichConfiguration.RichFormatterFeature.WHERE_CLAUSES)) {
                return localize(locale,
        ...
        protected String className(ClassType t, boolean longform, Locale locale) {
            ...
            if (sym.name.length() == 0 ||
                    !getConfiguration().isEnabled(RichConfiguration.RichFormatterFeature.SIMPLE_NAMES)) {
        ...
        public String visitTypeVar(TypeVar t, Locale locale) {
            if (unique(t) ||
                    !getConfiguration().isEnabled(RichConfiguration.RichFormatterFeature.UNIQUE_TYPEVAR_NAMES)) {
                return t.toString();
            }
            else {
                return localize(locale,
